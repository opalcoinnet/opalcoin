...
from test_framework.opalcoin_node import AUOPcoinTestNode
...
class OPALCOIN_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(AUOPcoinTestNode())
