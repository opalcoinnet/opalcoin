...
from fake_stake.base_test import OPALCOIN_FakeStakeTest

class zAUOPwrappedSerialsTest(OPALCOIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zAUOPs..." % DENOM_TO_USE)
