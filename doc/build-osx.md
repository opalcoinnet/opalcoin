...
1. Clone the Auop Coin source code:
        ...
        git clone https://github.com/opalcoinnet/opalcoin
        cd opalcoin
...
Auop Coin is now available at `./src/opalcoind`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/OPALCOIN"

    touch "/Users/${USER}/Library/Application Support/OPALCOIN/opalcoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/OPALCOIN/opalcoin.conf"

The first time you run opalcoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/OPALCOIN/debug.log

Other commands:
-------

    ./src/opalcoind -daemon # Starts the opalcoin daemon.
    ./src/opalcoin-cli --help # Outputs a list of command-line options.
    ./src/opalcoin-cli help # Outputs a list of RPC commands when the daemon is running.
