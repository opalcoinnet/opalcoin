...
The script [extract-osx-sdk.sh](https://github.com/opalcoinnet/opalcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
opalcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/opalcoinnet/opalcoin/blob/master/doc/README_osx.md) for troubleshooting tips.