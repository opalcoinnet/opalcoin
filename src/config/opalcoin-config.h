/* src/config/opalcoin-config.h.  Generated from opalcoin-config.h.in by configure.  */
/* src/config/opalcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AUOP_CONFIG_H

#define AUOP_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/opalcoinnet/opalcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Auop Coin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Auop Coin 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "opalcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://opalcoin.net/"
