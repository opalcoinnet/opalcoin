...
#include <QWidget>
#include <QString>
#include "qt/opalcoin/prunnable.h"
...
class PWidget : public QWidget, public Runnable
{
    Q_OBJECT
public:
    explicit PWidget(OPALCOINGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    OPALCOINGUI* getWindow() { return this->window; }
