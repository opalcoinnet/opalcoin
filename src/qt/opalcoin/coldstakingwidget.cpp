...
#include "qt/opalcoin/forms/ui_coldstakingwidget.h"
#include "qt/opalcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/opalcoin/requestdialog.h"
#include "qt/opalcoin/tooltipmenu.h"
#include "qt/opalcoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(OPALCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your AUOPs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept AUOP delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select AUOP outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 AUOP" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
