...
#include "qt/opalcoin/forms/ui_receivewidget.h"
...
#include "qt/opalcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(OPALCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive AUOP."));
