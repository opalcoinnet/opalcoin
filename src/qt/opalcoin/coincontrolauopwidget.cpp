...
#include "qt/opalcoin/coincontrolauopwidget.h"
#include "qt/opalcoin/forms/ui_coincontrolauopwidget.h"

CoinControlAUOPWidget::CoinControlAUOPWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlAUOPWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select AUOP Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("AUOP");
    ...
    ui->labelValueAfter->setText("0.00 AUOP");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 AUOP");
    ui->labelValueFee->setText("0.00 AUOP");
...
CoinControlAUOPWidget::~CoinControlAUOPWidget()
{
    delete ui;
}
