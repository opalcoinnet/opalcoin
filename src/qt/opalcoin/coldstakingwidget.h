...
#include "qt/opalcoin/furabstractlistitemdelegate.h"
#include "qt/opalcoin/txviewholder.h"
#include "qt/opalcoin/tooltipmenu.h"
#include "qt/opalcoin/sendmultirow.h"
#include "qt/opalcoin/coldstakingmodel.h"
#include "qt/opalcoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(OPALCOINGUI* parent);
    ~ColdStakingWidget();
