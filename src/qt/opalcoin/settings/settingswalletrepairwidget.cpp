...
#include "qt/opalcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/opalcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(OPALCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to OPALCOINGUI::handleRestart()
