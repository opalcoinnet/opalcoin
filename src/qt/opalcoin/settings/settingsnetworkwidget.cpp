...
#include "qt/opalcoin/settings/settingsnetworkwidget.h"
#include "qt/opalcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/opalcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(OPALCOINGUI* _window, QWidget *parent) :
