...
#include "qt/opalcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(OPALCOINGUI* _window, QWidget *parent) :
