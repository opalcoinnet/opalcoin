...
#include "qt/opalcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/opalcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(OPALCOINGUI* _window, QWidget *parent) :
