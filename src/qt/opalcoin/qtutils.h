...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, OPALCOINGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, OPALCOINGUI *gui, double posX = 3);
