...
#include "config/opalcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalAUOP = 0;
    qint64 totalZauop = 0;
    QList<qreal> valuesAUOP;
    QList<qreal> valueszAUOP;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(OPALCOINGUI* _window);
    ~DashboardWidget();
