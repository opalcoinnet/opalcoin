                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzAUOPPathCustom = GetArg("-zauopbackuppath", "");
    ...
    if(!strzAUOPPathCustom.empty()) {
        ui->wallet_customzauopbackuppath->setText(QString::fromStdString(strzAUOPPathCustom));
        ui->wallet_customzauopbackuppath_label->setVisible(true);
        ui->wallet_customzauopbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzAUOPPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the OPALCOIN RPC console.") + "<br>" +
