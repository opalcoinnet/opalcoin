...
/** Utility functions used by the OPALCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render OPALCOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZauop = false);
...
// Parse "opalcoin:" URI into recipient object, return true on successful parsing
