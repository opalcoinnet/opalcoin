...
#ifndef OPALCOIN_QT_WALLETMODEL_H
#define OPALCOIN_QT_WALLETMODEL_H
...
/** Interface to OPALCOIN wallet from Qt view code. */
...
#endif // OPALCOIN_QT_WALLETMODEL_H
