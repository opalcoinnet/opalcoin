...
// Copyright (c) 2015-2018 The OPALCOIN developers
...
/* OPALcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "OPALCOIN"
#define QAPP_ORG_DOMAIN "opalcoin.net"
#define QAPP_APP_NAME_DEFAULT "OPALCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "OPALCOIN-Qt-testnet"
