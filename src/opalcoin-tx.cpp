...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Auop Coin opalcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  opalcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded opalcoin transaction") + "\n" +
                               "  opalcoin-tx [options] -create [commands]   " + _("Create hex-encoded opalcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded opalcoin transaction
