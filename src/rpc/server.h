...
extern UniValue DoZauopSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzauopseed(const UniValue& params, bool fHelp);
extern UniValue getzauopseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzauop(const UniValue& params, bool fHelp);
extern UniValue dzauopstate(const UniValue& params, bool fHelp);
