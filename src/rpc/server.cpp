...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OPALCOIN features */
        {"opalcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"opalcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"opalcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"opalcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"opalcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"opalcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"opalcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"opalcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"opalcoin", "startmasternode", &startmasternode, true, true, false},
        {"opalcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"opalcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"opalcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"opalcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"opalcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"opalcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"opalcoin", "preparebudget", &preparebudget, true, true, false},
        {"opalcoin", "submitbudget", &submitbudget, true, true, false},
        {"opalcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"opalcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"opalcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"opalcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"opalcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"opalcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"opalcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"opalcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"opalcoin", "mnsync", &mnsync, true, true, false},
        {"opalcoin", "spork", &spork, true, true, false},
        {"opalcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> opalcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16485/\n";
}
