 ...
 * OPALCOIN system. There are three: the main network on which people trade goods
...
public:
    ...
    int AUOPcoinBadBlockTime() const { return nAUOPcoinBadBlockTime; }
    int AUOPcoinBadBlocknBits() const { return nAUOPcoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nAUOPcoinBadBlockTime;
    unsigned int nAUOPcoinBadBlocknBits;
