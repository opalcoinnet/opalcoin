// Copyright (c) 2017-2018 The OPALCOIN developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef OPALCOIN_ZAUOPWALLET_H
#define OPALCOIN_ZAUOPWALLET_H
...
public:
    CzAUOPWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZAUOP(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZAUOP(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
