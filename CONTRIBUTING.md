Contributing to Auop Coin
============================

The Auop Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/opalcoinnet/opalcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Auop Coin project, and is not to be
confused with overall OPALCOIN Network Protocol consensus changes.

Whether a pull request is merged into Auop Coin rests with the project merge
...
Patches that change OPALCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the OPALCOIN consensus, it must have been
...
The project leader is the release manager for each Auop Coin release.
